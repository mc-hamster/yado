...
void handleAdminConfAccounts() {
  ...
  message += "</tr>\n";
  message += "<tr>\n";
  message += "<td>Account 1</td>\n";
  message += "<td><input name=\"account_0\" type=\"text\" value=\"" + String(settings.accessGeneral[0].password) + "\" size=\"16\" maxlength=\"16\" /></td>\n";
  message += "</tr>\n";
  message += "<tr>\n";
  message += "<td>Account 2</td>\n";
  message += "<td><input name=\"account_1\" type=\"text\" value=\"" + String(settings.accessGeneral[1].password) + "\" size=\"16\" maxlength=\"16\" /></td>\n";
  message += "</tr>\n";
  message += "<tr>\n";
  message += "<td>Account 3</td>\n";
  message += "<td><input name=\"account_2\" type=\"text\" value=\"" + String(settings.accessGeneral[2].password) + "\" size=\"16\" maxlength=\"16\" /></td>\n";
  message += "</tr>\n";
  message += "<tr>\n";
  message += "<td>Account 4</td>\n";
  message += "<td><input name=\"account_3\" type=\"text\" value=\"" + String(settings.accessGeneral[3].password) + "\" size=\"16\" maxlength=\"16\" /></td>\n";
  message += "</tr>\n";
  message += "<tr>\n";
  message += "<td>Account 5</td>\n";
  message += "<td><input name=\"account_4\" type=\"text\" value=\"" + String(settings.accessGeneral[4].password) + "\" size=\"16\" maxlength=\"16\" /></td>\n";
  message += "</tr>\n";
  message += "</table>\n";
  message += "<p><br />\n";
